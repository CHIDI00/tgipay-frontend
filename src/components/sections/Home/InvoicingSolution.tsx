  ...
  return (
    ...
    >
      <div className="max-w-[90rem] px-4 mx-auto ">
        <div className="flex flex-col items-center gap-20 lg:gap-16 lg:flex-row">
          {/* card image  */}
          <FadeInAnimation
            duration={1}
            className="relative flex justify-start w-full lg:w-1/2 lg:justify-start"
          >
            <Image
              src={ogimageRaw}
            ...
            <Image
              ...
              width={350}
              height={300}
              className="absolute xl:left-72 lg:left-56 md:left-72 left-36 md:top-40 top-14 w-[60%] md:max-w-[350px] h-auto"
            />
          </FadeInAnimation>
